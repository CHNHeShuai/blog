        ...
        <div class="ad_content">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <td><img style="height: 50px ;width: 50px" src="${pageContext.request.contextPath}/${user.weixin}"></td>
                    <td>${user.telephone}</td>
                    <td>${user.email}</td>
                    <td>${user.address}</td>
                    <td>${user.job}</td>
                    <td>
                        <a style="background-color: #419c13" href="/toUpdateUser" class="btn btn-sm btn-danger">更新</a>
                    </td>
                </tr>
                </tbody>
            </table>
